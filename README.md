...
*   **[Peektrace](https://github.com/Mark-Life/peektrace):** Local-first, loopback-only inspector for AI coding agents — browse Claude, Codex, and Pi sessions with context-budget forensics, plus view and edit Claude Code memories across all projects. Ships as a single `curl | sh`-installable binary with the UI embedded.
